...
Если пользователь просит общий обзор бизнеса, ключевые показатели, состояние бизнеса, прибыльность, проблемы или “что важно сейчас” — сначала используй:
TOOL_CALL: {{"tool":"get_full_business_snapshot","args":{{"days":7}}}}

Если нужны и остатки, и прибыль — не вызывай два инструмента отдельно, сначала используй get_full_business_snapshot.
